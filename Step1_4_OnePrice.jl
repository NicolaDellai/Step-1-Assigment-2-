...
@variable(S14_OnePrice, w_im[h=1:H,s=1:S]) #real time imbalance created by the wind farm
@variable(S14_OnePrice, w_up[h=1:H,s=1:S] >= 0) #excess imbalance generated by the wind farm
@variable(S14_OnePrice, w_dw[h=1:H,s=1:S] >= 0) #deficict imbalance generated by the wind farm

@variable(S14_OnePrice, n[s=1:S] >= 0) #auxilliary variable
